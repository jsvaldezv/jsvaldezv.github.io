                ...
                <div className="pt-8">
                    ...
                    <div className="group relative flex gap-x-5">
                        ...
                        <div className="grow pb-8 group-last:pb-0">
                            ...
                            <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
                                The company has high expectations and using OKRs
                                there is a mutual understanding of expectations
                                and performance.
                            </p>
                    ...
                    <div className="group relative flex gap-x-5">
                        ...
                        <div className="grow pb-8 group-last:pb-0">
                            ...
                            <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
                                This is an excellent company and they reward
                                their employees. It's becoming a big company but
                                it's still private, so the culture is as good as
                                it gets at 1,000+ employees if you ask me.
                                Managers are still adapting to the growth I
                                        ...
                                        <div className="grow p-4 ms-32 sm:ms-48">
                                            <div className="min-h-24 flex flex-col justify-center">
                                                ...
                                                <p className="mt-1 text-sm text-gray-500 dark:text-neutral-500">
                                                    ...
                                                    reliable streams easily
                                                    leveraging Mailchimp's
                    ...
                    <div className="group relative flex gap-x-5">
                        ...
                        <div className="grow pb-8 group-last:pb-0">
                            ...
                            <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
                                Work in Slack is one of the beautiful experience
                                I can do in my entire life. There are a lot of
                                interesting thing to learn and manager respect
                                your time and your personality.
                            </p>
                        </div>
                        {/* End Right Content */}
                    </div>
                    ...
                    <div className="group relative flex gap-x-5">
                        ...
                        <div className="grow pb-8 group-last:pb-0">
                            ...
                            <ul className="list-disc ms-6 mt-3 space-y-1.5">
                                ...
                                <li className="ps-1 text-sm text-gray-600 dark:text-neutral-400">
                                    Utilized tools such as Notion for project
                                    tracking, Mailchimp for email marketing
                                    designs, Slack for team collaboration, and
                                    GitHub for version control and project
                                    sharing.
                                </li>
                            </ul>
                        </div>
